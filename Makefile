# This Makefile is for the Parse::AccessLog extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Parse/AccessLog.pm]
#     AUTHOR => [q[Nathan Marley <nathan.marley@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Parse::AccessLog]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Parse/AccessLog.pm]
#     clean => { FILES=>q[Parse-AccessLog-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Parse/AccessLog.pm
...
TO_INST_PM = lib/Parse/AccessLog.pm

PM_TO_BLIB = lib/Parse/AccessLog.pm \
...
DISTNAME = Parse-AccessLog
DISTVNAME = Parse-AccessLog-0.01
...
manifypods : pure_all  \
	lib/Parse/AccessLog.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Parse/AccessLog.pm $(INST_MAN3DIR)/Parse::AccessLog.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: "Parse Nginx/Apache access logs in \"combined\" format."' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Nathan Marley <nathan.marley@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Parse-AccessLog' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Parse Nginx/Apache access logs in \"combined\" format.",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Nathan Marley <nathan.marley@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Parse-AccessLog",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Parse Nginx/Apache access logs in "combined" format.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Nathan Marley &lt;nathan.marley@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Parse/AccessLog.pm blib/lib/Parse/AccessLog.pm 
